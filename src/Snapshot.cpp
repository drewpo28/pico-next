...
bool FileZ80::load(const string& z80_fn) {
    ...
    if (mkword(readByteFile(file),readByteFile(file)) != 0) { // Version 1
        ...
        if (z80version == 2) {
            ...
            if (mch == 9) z80_arch = "128K"; // Pentagon → fall back to 128K
    ...
    if (Config::arch != z80_arch) {
        ...
        if (z80_arch == "48K") {
            if (Config::pref_romSet_48 == "48K")
                z80_romset = Config::pref_romSet_48;
        } else
        if (z80_arch == "128K") {
            if (Config::pref_romSet_128 == "128K")
        ...
        if (z80_arch == "128K") {
            ...
            if (Config::romSet != "128K" && Config::romSet != "128Kcs") {
